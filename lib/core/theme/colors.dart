...
const Color primaryColor = Color(0xff1E75BC);
...
// backgrounds
Color firstBackgroundColor = const Color(0xff323232).withOpacity(0.7);
...
const Color dividerColorLight = Color(0xff9FB4FF);
